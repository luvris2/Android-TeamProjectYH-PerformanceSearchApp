...
//            cardView = itemView.findViewById(R.id.cardView);
            ...
            //list_row
            cardView = itemView.findViewById(R.id.cardView);
            txtTitle = itemView.findViewById(R.id.txtReviewListTitle);
            txtCreatedAt = itemView.findViewById(R.id.txtReviewListContent);
            txtRecommend = itemView.findViewById(R.id.txtReviewRecommend);
            txtNickName = itemView.findViewById(R.id.txtReviewListName);
