...
public class MainActivity extends AppCompatActivity {
    ...
    double gpsX, gpsY; // 위도, 경도
    String mySidoLocation; // API 호출 파라미터(지역코드) 저장 변수
    ...
    // 마지막 위치 정보 불러오기, 해당 기능은 gps 수신 속도를 높여주기 위하여 사용
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, location -> {
                    if (location != null) {
                        ...
                        Toast.makeText(getApplicationContext(), "마지막 위치 정보를 확인 할 수 없습니다.\n위치 정보 수신을 위해 잠시만 기다려주세요.", Toast.LENGTH_LONG).show();
                        getLocation();
                    }
                });
    ...
    public String getMySidoLocation(LatLng location) {
        ...
        if (location != null) {
            ...
            Toast.makeText(getApplicationContext(), "GPS 수신이 양호하지 않습니다.\n앱이 정상작동하지 않을 수 있습니다.", Toast.LENGTH_LONG).show();
            return null;
        }
